...
Morrow is a Mojo library for date and time work. It provides a date-time API for constructing, parsing, formatting, shifting, comparing, and humanizing date-time values.
...
- Parse and format strings with token-based tokens and Python-style `strftime`.
